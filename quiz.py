...
#I had a hard time running db I kept getting error I tried everything and installed mysqlconnector but It was still not working.
class Question:
...
def askQuestion():
    ...
    if(len(questions) == index + 1):
        Label(window, text="Thank you and please try again!. " + str(right) + " of " + str(number_of_questions) + " questions answered right").pack()
        return
    button.pack_forget()
    index += 1
